...
public class Process { //PCB CodeSegment StackSegment HeapSegment
	...
	public void initialize() {
		this.setState(Process.EState.running);
	}
	...
	private void excuteCode(int code) {
		...
		System.out.println("ID:"+ this.pcb.getId()+ " "+EInstruction.values()[instruction]+"    state: "+this.pcb.geteState());
	...
	public void runIO() {
		...
		Thread thread = new Thread(this.pcb.getIODevice());
		thread.start(); 
	}
	public void setState(EState state) {
		System.out.println("ID: "+this.pcb.getId()+" "+this.pcb.geteState()+"-->"+state);
		this.pcb.seteState(state);
	}
